...
const CardPreview: React.FC<CardPreviewProps> = ({
  ...
  const renderElement = (element: CardElement) => {
    ...
    const renderIcon = () => {
      ...
      const iconColor =
        element.props.iconColor || element.props.color || "#000000";
    ...
    switch (element.type) {
      case "text":
        ...
        return (
          <div
            style={{ display: "flex", alignItems: "center", ...commonStyle }}
          >
            ...
            {iconPosition === "right" && (
              <span
                style={{ marginLeft: `${element.props.iconSpacing || 0}px` }}
              >
                {renderIcon()}
              </span>
            )}
      ...
      {elements.map((element) => (
        <div
          ...
          className={`absolute cursor-move ${
            dragging && selectedElement === element.id
              ? "pointer-events-none"
              : ""
          }`}
          style={{
