...
import { ChevronLeft, ChevronRight, Layout, Image, Type, Square, QrCode, Plus, Trash2 } from 'lucide-react';
...
const ElementEditor: React.FC<{ element: CardElement; updateElement: Function; deleteElement: Function; updateLogoScale: Function }> = ({ element, updateElement, deleteElement,  updateLogoScale,
 }) => {
  const handleChange = (key: string, value: any) => {
    updateElement(element.id, { [key]: value });
  };
  const [activeSection, setActiveSection] = useState<'text' | 'icon' | 'style' | 'shadow'>('text');
  ...
  const renderIconSection = () => (
    <>
      ...
      />
      <div className="mt-4">
        <label className="block mb-2 text-sm font-medium text-gray-700">Icon Size</label>
        <input
          type="number"
          min="8"
          max="72"
          ...
          />
        <span className="text-sm text-gray-600">{element.props.iconSize || element.props.fontSize || 16}px</span>
      </div>
      <div className="mt-4">
        <label className="block mb-2 text-sm font-medium text-gray-700">Icon Color</label>
        <input
          type="color"
      ...
      <div className="mt-4">
        <label className="block mb-2 text-sm font-medium text-gray-700">Icon Position</label>
        <div className="flex space-x-2">
          <button
            onClick={() => handleChange('iconPosition', 'left')}
            className={`px-4 py-2 text-sm font-medium ${element.props.iconPosition !== 'right' ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-700'}`}
          >
            Left
          </button>
          <button
      ...
      <div className="mt-4">
        <label className="block mb-2 text-sm font-medium text-gray-700">Icon Spacing</label>
        <input
          type="number"
          min="0"
          max="50"
          ...
          className="w-full px-4 py-2 text-gray-700 bg-white border-b-4 border-separate focus:outline-none"
          />
        <span className="text-sm text-gray-600">{element.props.iconSpacing || 0}px</span>
      </div>
    </>
  );
    ...
    <>
      <div className="mb-4">
        ...
        <input
          ...
          className="w-full px-4 py-2 text-gray-700 bg-white border-b-4 border-separate focus:outline-none"
          />
        <span className="text-sm text-gray-600">{element.props.fontSize || 16}px</span>
      </div>
      <div className="mb-4">
      ...
      <div className="mb-4 grid grid-cols-3 gap-2">
        <button
          onClick={() => handleChange('fontWeight', element.props.fontWeight === 'bold' ? 'normal' : 'bold')}
          className={`py-2 text-sm font-medium transition duration-200 ${element.props.fontWeight === 'bold' ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
        >
          Bold
        </button>
        <button
          onClick={() => handleChange('fontStyle', element.props.fontStyle === 'italic' ? 'normal' : 'italic')}
          className={`py-2 text-sm font-medium transition duration-200 ${element.props.fontStyle === 'italic' ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
        >
          Italic
        </button>
        <button
          onClick={() => handleChange('textDecoration', element.props.textDecoration === 'underline' ? 'none' : 'underline')}
          className={`py-2 text-sm font-medium transition duration-200 ${element.props.textDecoration === 'underline' ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
        >
          Underline
        </button>
      </div>
      <div className="mb-4">
        <label className="block mb-2 text-sm font-medium text-gray-700">Letter Spacing</label>
        <input
          type="number"
          min="0"
          max="20"
          ...
          className="w-full px-4 py-2 text-gray-700 bg-white border-b-4 border-separate focus:outline-none"
          />
        <span className="text-sm text-gray-600">{element.props.letterSpacing || 0}px</span>
      </div>
      <div className="mb-4">
        <label className="block mb-2 text-sm font-medium text-gray-700">Rotation</label>
        <input
          type="number"
          min="0"
          max="360"
          ...
          className="w-full px-4 py-2 text-gray-700 bg-white border-b-4 border-separate focus:outline-none"
          />
        <span className="text-sm text-gray-600">{element.props.rotation || 0}°</span>
      </div>
      <div className="mb-4">
        <label className="block mb-2 text-sm font-medium text-gray-700">Opacity</label>
        <input
          type="number"
          min="0"
          max="100"
          ...
          className="w-full px-4 py-2 text-gray-700 bg-white border-b-4 border-separate focus:outline-none"
          />
        <span className="text-sm text-gray-600">{Math.round((element.props.opacity || 1) * 100)}%</span>
      </div>
    </>
  );
  ...
  const renderShadowSection = () => (
    <>
      <div className="mb-4">
        <label className="block mb-2 text-sm font-medium text-gray-700">Shadow Offset X</label>
        <input
          type="number"
          min="-50"
          max="50"
          ...
          className="w-full px-4 py-2 text-gray-700 bg-white border-b-4 border-separate focus:outline-none"
          />
        <span className="text-sm text-gray-600">{element.props.offsetX || 0}px</span>
      </div>
      <div className="mb-4">
        <label className="block mb-2 text-sm font-medium text-gray-700">Shadow Offset Y</label>
        <input
          type="number"
          min="-50"
          max="50"
          ...
          className="w-full px-4 py-2 text-gray-700 bg-white border-b-4 border-separate focus:outline-none"
          />
        <span className="text-sm text-gray-600">{element.props.offsetY || 0}px</span>
      </div>
      <div className="mb-4">
        <label className="block mb-2 text-sm font-medium text-gray-700">Shadow Blur</label>
        <input
          type="number"
          min="0"
          max="30"
          ...
          className="w-full px-4 py-2 text-gray-700 bg-white border-b-4 border-separate focus:outline-none"
          />
        <span className="text-sm text-gray-600">{element.props.blur || 0}px</span>
      </div>
      <div className="mb-4">
        <label className="block mb-2 text-sm font-medium text-gray-700">Shadow Color</label>
        <input
          type="color"
  ...
  const renderQRCodeSection = () => (
    ...
    <div>
      <label className="block text-sm font-medium text-gray-600 mb-2">QR Code Content</label>
      <input
        type="text"
        value={element.props.content}
        onChange={(e) => handleChange('content', e.target.value)}
    ...
    <div>
      <label className="block text-sm font-medium text-gray-600 mb-2">QR Code Color</label>
      <input
        type="color"
        value={element.props.color || '#000000'}
        onChange={(e) => handleChange('color', e.target.value)}
    ...
    <div>
      <label className="block text-sm font-medium text-gray-600 mb-2">QR Code Background</label>
      <input
        type="color"
    ...
    <div>
      <button
        onClick={() => handleChange('qrBackground', element.props.qrBackground === 'transparent' ? '#ffffff' : 'transparent')}
      ...
      >
        {element.props.qrBackground === 'transparent' ? 'Set White Background' : 'Set Transparent Background'}
      </button>
    </div>
    <div>
      <label className="block text-sm font-medium text-gray-600 mb-2">QR Code Size</label>
      <div className="flex items-center space-x-4">
        <input
          ...
          className="w-full p-2 bg-gray-50 hover:bg-gray-100 transition-colors duration-200 text-sm text-gray-600 focus:outline-none"
        />
        <span className="text-sm text-gray-600 whitespace-nowrap">{element.props.size || 100}px</span>
      </div>
    </div>
  </div>
  );
  ...
  const renderShapeSection = () => (
    ...
    <div className="space-y-6">
      <div>
        <label className="block text-sm font-medium text-gray-600 mb-2">Shape Color</label>
        <input
          type="color"
          value={element.props.color || '#000000'}
          onChange={(e) => handleChange('color', e.target.value)}
      ...
      <div>
        <label className="block text-sm font-medium text-gray-600 mb-2">Shape Size</label>
        <div className="flex items-center space-x-4">
          <input
            type="number"
            min="10"
      ...
      <div>
        ...
        <div className="flex items-center space-x-4">
          <input
            ...
            className="w-full p-2 bg-gray-50 hover:bg-gray-100 transition-colors duration-200 text-sm text-gray-600 focus:outline-none"
          />
          <span className="text-sm text-gray-600 whitespace-nowrap">{element.props.borderRadius || 0}px</span>
        </div>
      </div>
    </div>
  </>
  ...
  <div className="space-y-6">
    ...
    <div>
      <label className="block text-sm font-medium text-gray-600 mb-2">Image Size</label>
      <div className="flex items-center space-x-4">
        <input
          type="number"
          min="10"
    ...
    <div className="space-y-8">
      <div>
        ...
        <input
          ...
          onChange={(e) => setState((prevState: any) => ({ ...prevState, backgroundColor: e.target.value }))}
          className="w-full h-12 cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors duration-200"
        />
      </div>

      <div>
        <label className="block text-sm font-medium text-gray-600 mb-2">Upload Background Image</label>
        <input
          type="file"
          accept="image/*"
      ...
      <div>
        <label className="block text-sm font-medium text-gray-600 mb-2">Overlay Color</label>
        <input
          type="color"
          value={overlayColor}
          onChange={(e) => setState((prevState: any) => ({ ...prevState, overlayColor: e.target.value }))}
          className="w-full h-12 cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors duration-200"
        />
      </div>
      <div>
        ...
        <div className="flex items-center space-x-4">
          <input
            ...
            onChange={(e) => setState((prevState: any) => ({ ...prevState, overlayOpacity: Number(e.target.value) }))}
            className="w-full p-2 bg-gray-50 hover:bg-gray-100 transition-colors duration-200 text-sm text-gray-600 focus:outline-none"
          />
...
<div className="bg-white shadow-sm">
  <div className="flex justify-between items-center px-6 py-3">
    <button onClick={undo} className="px-4 py-2 text-sm font-medium text-indigo-600 hover:text-indigo-800 transition-colors duration-200 focus:outline-none">
      Undo
    </button>
    <button onClick={redo} className="px-4 py-2 text-sm font-medium text-indigo-600 hover:text-indigo-800 transition-colors duration-200 focus:outline-none">
      Redo
    </button>
  </div>
  <div className="">
          ...
          {selectedElement && (
            <div className="mt-6 pt-6">
              {elements.find(el => el.id === selectedElement) ? (
                ...
                <p className="text-gray-600">No element selected. Please select an element to edit.</p>
              )}
            </div>
          )}
      </div>
