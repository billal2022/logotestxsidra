...
import {
  ...
  ModularBusinessCardStudio,
} from "./businesscard/bussiness";
...
const colorPatterns = [
  {
    name: "Aerospace",
    colors: [
      { r: 0.0, g: 0.12, b: 0.24 }, // Oxford Blue
      { r: 0.87, g: 0.87, b: 0.87 }, // Gainsboro
      { r: 0.53, g: 0.81, b: 0.98 }, // Light Sky Blue
      { r: 0.7, g: 0.13, b: 0.13 }, // Firebrick
    ],
  },
  {
    name: "Professional",
    colors: [
      { r: 0.0, g: 0.16, b: 0.36 }, // Navy
      { r: 0.71, g: 0.8, b: 0.86 }, // Light Slate Gray
      { r: 0.87, g: 0.9, b: 0.94 }, // Gainsboro
      { r: 0.2, g: 0.28, b: 0.37 }, // Dark Slate
    ],
  },
  {
    name: "Minimalist",
  ...
  },
  {
    name: "Vibrant",
    colors: [
      { r: 0.8, g: 0.0, b: 0.0 }, // Red
      { r: 0.98, g: 0.8, b: 0.18 }, // Mustard
      { r: 0.04, g: 0.52, b: 0.89 }, // Blue (RYB)
      { r: 0.0, g: 0.6, b: 0.0 }, // Green
    ],
  },
  {
    name: "Pastel",
    colors: [
      ...
      { r: 0.8, g: 0.88, b: 0.97 }, // Light Steel Blue
      { r: 0.86, g: 0.82, b: 0.9 }, // Thistle
    ],
  },
  {
    name: "Earthy Tones",
    colors: [
      ...
      { r: 0.91, g: 0.9, b: 0.88 }, // Very light gray
  ...
  },
  {
    ...
    colors: [
      ...
      { r: 0.93, g: 0.36, b: 0.0 }, // Persimmon
    ],
  },
  {
    name: "Sustainable Energy",
    colors: [
      { r: 0.0, g: 0.5, b: 0.5 }, // Teal
  ...
  },
  {
    name: "Gourmet Food",
    colors: [
      { r: 0.55, g: 0.0, b: 0.0 }, // Dark Red
      { r: 0.98, g: 0.94, b: 0.9 }, // Linen
      { r: 0.2, g: 0.2, b: 0.2 }, // Rich Black
  ...
  },
  {
    ...
    colors: [
      ...
      { r: 0.0, g: 0.59, b: 0.53 }, // Persian Green
    ],
  },
  {
    name: "Boutique Hotel",
...

  {
    ...
    colors: [
      ...
      { r: 0.8, g: 0.52, b: 0.25 }, // Peru
    ],
  },
  {
    name: "Digital Marketing",
    colors: [
      { r: 0.2, g: 0.6, b: 0.86 }, // Bright Cerulean
      { r: 0.98, g: 0.98, b: 0.98 }, // Cultured
      { r: 0.13, g: 0.13, b: 0.13 }, // Eerie Black
      { r: 1.0, g: 0.41, b: 0.71 }, // Hot Pink
    ],
  },
];
...
const getRandomColorWithContrast = (bgColorHex: string) => {
  ...
  let newColor = "";
  while (contrast < 3) {
    // Minimum contrast ratio; increase for more contrast
...
const Form: React.FC = () => {
  ...
  const handleAccentFontSizeChange = (newSize: number) =>
    setAccentFontSize(newSize);
  const handleAccentLetterSpacingChange = (newSpacing: number) =>
    setAccentLetterSpacing(newSpacing);
  ...
  const currentTabConfig =
    activeMainTab === "logo" ? tabConfig : businessCardTabConfig;

  const handleColorPatternChange = useCallback(
    (pattern: (typeof colorPatterns)[0]) => {
      ...
      <LogoProvider>
        <div className="flex flex-col w-full h-screen bg-white overflow-hidden">
            ...
            <ul className="flex justify-between items-center px-4 md:px-0 overflow-x-auto">
              {currentTabConfig.map((tab) => (
                <li key={tab.name} className="flex-1 min-w-max">
                  ...
                  >
                    {tab.icon}
                    <span>{`${tab.name.charAt(0).toUpperCase()}${tab.name.slice(
                      1
                    )}`}</span>
                  </button>
                </li>
          ...
          <div className="flex flex-grow overflow-hidden relative">
            {/* Sidebar */}
            <div
              className={`bg-white w-full lg:w-96 p-4 overflow-auto shadow-lg transition-all duration-300 
          ${
            isSidebarOpen || innerWidth > 1024
              ? "translate-x-0"
              : "-translate-x-full"
          } 
                  ...
                  {activeTab === "settings" && (
                    <div className="flex-1 space-y-6">
                      <ModularBusinessCardStudio
                        ...
                        LogoDisplay={LogoDisplayWrapper}
                      />
                    </div>
                  )}
                </>
